...
?>		
		<div id="about" class="content black-bg">
        	<div class="container">
                <div class="row">
                    <div class="col-md-6 align-center col-md-offset-3">
						...
						<!--  CHANGED CLASS FROM "sub-title" TO "sub-title-slim"  -->
						<p class="sub-title-slim"><?php if ( function_exists( 'ot_get_option' )&& ot_get_option( 'about_subtitle' ) ) { echo ot_get_option( 'about_subtitle' );} else {
							_e('About Us','beuh'); } ?></p>							
						<!--  REMOVING "liner" TO MAKE ABOUT SECTION SLIM  -->
						<!--  <div class="liner"></div>  -->
						<?php if ( function_exists( 'ot_get_option' )&& ot_get_option( 'about_detail' ) ) { echo ot_get_option( 'about_detail' );} ?>
						<!--  REMOVING "spacing40" TO MAKE ABOUT SECTION SLIM  -->
